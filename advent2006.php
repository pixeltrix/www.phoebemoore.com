<html>
<head>
<title>Phoebe &amp; Nathan's Advent 2006</title>
...
<?php
	...
	switch ($action) {
		...
		case 'submitCaption':
			...
			$subject = "Caption Competition 2006 - Day {$day}";
...
<?php
	...
	function caption($day) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . '/images/2006/captions/' . sprintf('%02d', $day) . '.html';
	...
	if (time() < mktime(0, 0, 0, 12, 26, 2006)) {
		$n = intval(date('j'));
	} else {
		$n = 25;
	}
	...
	for ($i = 1; $i <= $n; $i++) {
		$preload[] = "'/images/2006/days/" . sprintf('%02d', $i) . "_d.gif'";
	}
...
<body onLoad="PX_preloadImages();MM_preloadImages('/images/2006/buttons/caption_o.gif','/images/2006/buttons/email_o.gif')">
...
<tr>
<td valign="top"><img src="/images/titles/2006.gif" alt="Phoebe &amp; Nathan's Advent 2006" width="330" height="21"></td>
<td align="right" valign="top"><a href="mailto:phoebe@mooremail.co.uk" onMouseOver="MM_swapImage('EmailButton','','/images/2006/buttons/email_o.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="/images/2006/buttons/email.gif" alt="Email" name="EmailButton" width="34" height="17" border="0" id="EmailButton"></a></td>
</tr>
<tr>
...
<?php if (($i <= $day) && (is_file("{$_SERVER['DOCUMENT_ROOT']}/images/2006/photos/{$name}.jpg"))) :?>
<td><a href="#" onClick="MM_nbGroup('down','group1','Day<?=$name;?>','/images/2006/days/<?=$name;?>_d.gif',1);MM_swapImage('Photo','', '/images/2006/photos/<?=$name;?>.jpg',1);MM_setTextOfLayer('Caption','', photoCaptions[<?=$i;?>]);return false;"><img src="/images/2006/days/<?=$name;?>_o.gif" name="Day<?=$name;?>" width="18" height="18" border="0" id="Day<?=$name;?>" alt="<?=$name;?>"></a></td>
<?php else :?>
<td><img src="/images/2006/days/<?=$name;?>.gif" width="18" height="18" border="0" alt="<?=$name;?>"></td>
<?php endif;?>
<?php if ($i < 25) :?>
...
<tr>
<td colspan="2"><img src="/images/shim/orange.gif" alt="Photo" name="Photo" width="498" height="350" id="Photo"></td>
</tr>
<tr>
<td colspan="2"><img src="/images/shim/s.gif" width="498" height="2"></td>
</tr>
...
<div id="CaptionForm">
<form action="/advent2006.php?action=submitCaption" method="post" name="CaptionForm" onSubmit="MM_validateForm('name','','R','email','','RisEmail','caption','','R');return document.MM_returnValue">
<div><img src="/images/2006/titles/caption_comp.gif" width="208" height="22"></div>
...
<div><img src="/images/2006/titles/caption_comp.gif" width="208" height="22"></div>
<div id="Balloon"><a href="/advent2006.php"><img src="/images/2006/titles/caption_sent.gif" width="209" height="155" border="0"></a></div>
</div>
</div>
</td>
</tr>
...
<td>
<?php if ($action == 'defaultAction'):?>
<a href="/advent2006.php?action=editCaption"><img src="/images/2006/buttons/caption.gif" alt="Caption Competition" name="CaptionButton" width="140" height="14" border="0" id="CaptionButton" onMouseOver="MM_swapImage('CaptionButton','','/images/2006/buttons/caption_o.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
<?php else:?>
&nbsp;
<?php endif;?>
</td>
